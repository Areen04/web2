...
<div class="container my-5">
    <div class="card shadow">
        ...
        <div class="card-body d-flex align-items-center">
            <img src="uploads/<?= htmlspecialchars($doctor['uniqueFileName']) ?>" alt="Doctor Image" class="rounded-circle me-4" style="width: 120px; height: 120px; object-fit: cover;">
            <div>
...
<tr>
    ...
    <td>
        ...
        <?php elseif ($row['status'] == 'Confirmed'): ?>
            <a href="preMed.php?appointment_id=<?= $row['appointment_id'] ?>" class="btn btn-success btn-sm">Prescribe</a>
        <?php endif; ?>
    </td>
</tr>
<?php endwhile; ?>
...
<tr>
    ...
    <span class="text-muted">Already prescribed</span>
<?php else: ?>
    <a href="preMed.php?appointment_id=<?= $row['appointment_id'] ?>" class="btn btn-success btn-sm">Prescribe</a>
<?php endif; ?>
    </td>
